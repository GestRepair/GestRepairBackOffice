...
public final class Table_Budgets_PU extends javax.swing.JFrame {
     ...
     */
    public Table_Budgets_PU(String login, int id) throws IOException, MalformedURLException, ParseException, java.text.ParseException {
        log = login;
        this.id = id;
        initComponents();
    ...
    private void bt_editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_editActionPerformed
        ...
        try {
            ...
            Logger.getLogger(Table_Budgets_PU.class.getName()).log(Level.SEVERE, null, ex);
        }
