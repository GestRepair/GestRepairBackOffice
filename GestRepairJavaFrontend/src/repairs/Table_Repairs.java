...
public final class Table_Repairs extends javax.swing.JFrame {
     ...
     */
    public Table_Repairs(String login) throws IOException, MalformedURLException, ParseException, java.text.ParseException {
        log = login;
        initComponents();
    ...
    private void initComponents() {
        ...
        tbl_vehicles.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Serviço", "Descrição", "Preço", "Estado", "Data Inicio", "Data Conclusão", "Resolução", "Funcionário"
            }
        ) {
